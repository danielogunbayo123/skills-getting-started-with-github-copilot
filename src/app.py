...
activities = {
    ...
    "Soccer Practice": {
        "description": "Outdoor soccer training and drills",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["nina@mergington.edu", "liam@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Team basketball practice and pick-up games",
        "schedule": "Wednesdays, 5:00 PM - 6:30 PM",
        "max_participants": 18,
        "participants": ["alex@mergington.edu", "mia@mergington.edu"]
    },
    "Drama Club": {
        "description": "Explore theater, acting, and stagecraft",
        "schedule": "Mondays, 4:00 PM - 5:30 PM",
        "max_participants": 25,
        "participants": ["sophia@mergington.edu", "jacob@mergington.edu"]
    },
    "Art Workshop": {
        "description": "Hands-on visual art projects and critique sessions",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["emma@mergington.edu", "ava@mergington.edu"]
    },
    "Music Ensemble": {
        "description": "Group music rehearsals and performances",
    ...
    "Mathletes": {
        "description": "Mathematics problem solving and competition prep",
